...
public class MyLinkedList implements NodeList {
    ...
    public boolean addItem(ListItem newItem) {
        if (this.root == null) {
            //The list was empty, so the item we are adding(newItem) is added to the root
            this.root = newItem;
            return true;
        }
        ...
        while (currentItem != null) {
            ...
            if (comparison < 0) {
                ...
                if (currentItem.next() != null) {
                    ...
                    //there is no next so insert it at the end of the list
    ...
    public boolean removeItem(ListItem item) {
        ...
        while (currentItem != null) {
            ...
            if (comparison == 0) {
                ...
                //passed the value to remove, return false
                return false;
            }
        }
        return false;
